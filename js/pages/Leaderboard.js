        ...
        <main v-else class="page-leaderboard-container">
            ...
            <div class="page-leaderboard">
                        ...
                        <tr v-for="(ientry, i) in leaderboard">
                            ...
                            <td class="user" :class="{ 'active': selected == i }">
                                <button @click="selected = i">
                                    <span class="type-label-lg"> <template v-if="entry.flag">{{ countryToFlag(ientry.flag) }}&nbsp;</template>{{ ientry.user }}</span>
                                </button>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="player-container" v-show="!store.mobile || mobileTab === 'player'">
                    <div class="player">
                        <h1>#{{ selected + 1 }} <template v-if="entry.flag">{{ countryToFlag(entry.flag) }}&nbsp;</template>{{ entry.user }}</h1>
